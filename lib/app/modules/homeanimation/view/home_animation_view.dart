import 'package:ehoa/app/components/animation_widget.dart';
      ...
      return Scaffold(
        ...
        body: Stack(
          ...
          children: [
            ...
            Positioned(
              top: MediaQuery.of(AppService.getContext()).size.height * 0.07,
              //  left: MediaQuery.of(AppService.getContext()).size.width*0.25,
              child: Center(
                  child: subHeadingText(Strings.iamfeeling, fontSize: 18)),
            ),
            Positioned(
                // top: MediaQuery.of(AppService.getContext()).size.height * 0.01,
                child: SizedBox(width: 500.w, child: AnimationWidget())),
          ],
        ),
      );
    });
