  ...
  Widget build(BuildContext context) {
    return GetBuilder<SymptomsController>(builder: (c) {
      return baseBody(
        c.isLoading,
        SafeArea(
          child: MySharedPref.getProtype() != "1"
              ? UnlockPremium(
                  close: () {
                    Get.back();
                  },
                  descri:Strings.trackursys,
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            SingleChildScrollView(
                              ...
                              child: Row(
                                children: List.generate(c.menstrualFlow.length,
                                    (index) {
                            ...
                            SingleChildScrollView(
                              ...
                              child: Row(
                                children:
                                    List.generate(c.symptoms.length, (index) {
                                  return ReportingCard(
                            ...
                            SingleChildScrollView(
                              ...
                              child: Row(
                                children:
                                    List.generate(c.emotions.length, (index) {
                                  return ReportingCard(
                            ...
                            SingleChildScrollView(
                              ...
                              child: Row(
                                children:
                                    List.generate(c.energy.length, (index) {
                                  return ReportingCard(
                                    data: c.energy[index],
                                    onTap: () {
